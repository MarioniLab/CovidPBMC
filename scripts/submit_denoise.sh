...
#SBATCH --output=/mnt/scratchb/jmlab/morgan02/Covid/logs/Run_denoise.out
#SBATCH --error=/mnt/scratchb/jmlab/morgan02/Covid/logs/Run_denoise.err
#SBATCH --mem=48000
#SBATCH -n1 
#SBATCH -c1
...
Rscript /mnt/scratchb/jmlab/morgan02/Covid/scripts/denoise_ADT.R --SCElist $SCEfiles --DonorList $DonorFiles --matrixlist $matrixFiles --whitelist $cellFiles --IgControls IgG1_Ctrl,IgG2a_Ctrl,IgG2b_Ctrl,IgG2b_RatCtrl --plots $BASE_DIR/reports/Covid_ADT- --output $BASE_DIR/Projections/Covid_ADT --UMIthreshold 10
