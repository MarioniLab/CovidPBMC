...
sigac2.tcr.contigs <- read.table("/mnt/scratchb/jmlab/morgan02/Covid/cellranger_output/SIGAB2_BCR/outs/filtered_contig_annotations.csv",
		                sep=",", header=TRUE, stringsAsFactors=FALSE)
sigac2.tcr.contigs$Sample <- paste0("SIGAA2_", sigac2.tcr.contigs$barcode)
sigac2.tcr.contigs$ExpSample <- "SIGAB2"

sigac3.tcr.contigs <- read.table("/mnt/scratchb/jmlab/morgan02/Covid/cellranger_output/SIGAB3_BCR/outs/filtered_contig_annotations.csv",
		                sep=",", header=TRUE, stringsAsFactors=FALSE)
sigac3.tcr.contigs$Sample <- paste0("SIGAA3_", sigac3.tcr.contigs$barcode)
sigac3.tcr.contigs$ExpSample <- "SIGAB3"
...
write.table(tcr.contigs, file="/mnt/scratchb/jmlab/morgan02/Covid/SCE/BCR_contigs_ALL.tsv",
